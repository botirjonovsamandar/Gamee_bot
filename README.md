...
- после `17:00 UZ` проверка и клейм daily идут в обычном account loop;
- если награда уже забрана, это запоминается по ключу дня и повторно не клеймится до следующего reset.
